...
PYBIND11_MODULE(pyllumina, m)
{
    m.doc() = "Parses idat files";
    py::class_<IdatData>(m, "IdatData")
        .def(
            py::init< const std::string& >(),
            py::arg("filepath")
        )
        // .def_property(
            // "metric", &IdatWrapper::get_metric, &IdatWrapper::set_metric
        // )
        // .def_property(
            // "p_metric", &IdatWrapper::get_p_metric, &IdatWrapper::set_p_metric
        // )
        // .def_property(
            // "n_neighbors", &IdatWrapper::get_n_neighbors,
            // &IdatWrapper::set_n_neighbors
        // )
        // .def_property(
            // "n_trees", &IdatWrapper::get_n_trees, &IdatWrapper::set_n_trees
        // )
        // .def_property(
            // "leaf_size", &IdatWrapper::get_leaf_size, &IdatWrapper::set_leaf_size
        // )
        // .def_property(
            // "pruning_degree_multiplier",
            // &IdatWrapper::get_pruning_degree_multiplier,
            // &IdatWrapper::set_pruning_degree_multiplier
        // )
        // .def_property(
            // "pruning_prob",
            // &IdatWrapper::get_pruning_prob,
            // &IdatWrapper::set_pruning_prob
        // )
        // .def_property(
            // "tree_init", &IdatWrapper::get_tree_init, &IdatWrapper::set_tree_init
        // )
        // .def_property("seed", &IdatWrapper::get_seed, &IdatWrapper::set_seed)
        // .def_property(
            // "max_candidates",
            // &IdatWrapper::get_max_candidates,
            // &IdatWrapper::set_max_candidates
        // )
        // .def_property(
            // "n_iters", &IdatWrapper::get_n_iters, &IdatWrapper::set_n_iters
        // )
        // .def_property(
            // "delta", &IdatWrapper::get_delta, &IdatWrapper::set_delta
        // )
        // .def_property(
            // "n_threads", &IdatWrapper::get_n_threads, &IdatWrapper::set_n_threads
        // )
        // .def_property(
            // "verbose", &IdatWrapper::get_verbose, &IdatWrapper::set_verbose
        // )
        // .def_property(
            // "algorithm", &IdatWrapper::get_algorithm, &IdatWrapper::set_algorithm
        // )
        .def_property_readonly("filesize", &IdatData::get_file_size)
        // .def_property_readonly("csr_data", &IdatWrapper::get_csr_data)
        // .def_property_readonly("indices", &IdatWrapper::get_indices)
        // .def_property_readonly("distances", &IdatWrapper::get_distances)
        // .def_property_readonly(
            // "neighbor_graph", &IdatWrapper::get_neighbor_graph
        // )
        // .def_property_readonly("flags", &IdatWrapper::get_flags)
    ;
}
...
// /**
 // * @brief Wrapper class for binding the IdatData class in Python.
 // */
// class IdatWrapper
// {
// private:
...
// {
    ...
    // py::class_<IdatWrapper>(m, "NNDescent")
        // .def(
            // py::init<
                // py::object&,
                // const std::string&,
        ...
        // .def_property(
            // "algorithm", &IdatWrapper::get_algorithm, &IdatWrapper::set_algorithm
        // )
        // .def_property_readonly("data", &IdatWrapper::get_data)
        // .def_property_readonly("csr_data", &IdatWrapper::get_csr_data)
        // .def_property_readonly("indices", &IdatWrapper::get_indices)
        // .def_property_readonly("distances", &IdatWrapper::get_distances)
        // .def_property_readonly(
